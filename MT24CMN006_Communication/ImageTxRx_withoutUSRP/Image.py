...
# Title: Image Transmission and Reception with USRP
# Author: Rima Thakur
...
class Image(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Image Transmission and Reception with USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Image Transmission and Reception with USRP")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\Asus\\Desktop\\img1.raw', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\Asus\\Desktop\\received_image2.raw', False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.digital_ofdm_rx_0_0, 0))
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_complex_to_float_0_1, 0))
